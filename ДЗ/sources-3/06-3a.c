/* Программа 1 (06-3а.с) для иллюстрации некорректной работы с разделяемой памятью */
...
т. е. данной программы, второй элемент массива – счетчиком числа запусков
программы 2, третий элемент массива – счетчиком числа запусков обеих программ */
#include <sys/types.h>
#include <sys/ipc.h>
#include <sys/shm.h>
#include <stdio.h>
